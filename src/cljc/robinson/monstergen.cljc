...
(def ^:private monsters
  ...
  ;;        |               |                |                |    | | |     |     |    | |                                           |                             |                       |                                       | status
  (Monster. :rat            "rat"            "rats"           nil  5 0 0.6   0.2   5    5 #{:face :head :neck :body :leg :tail}       #{:bite :claw}                :hostile                :follow-player-in-range-or-random       5 #{:hostile})
  ...
  (Monster. :red-frog       "red frog"       "red frogs"      nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:hostile})
  (Monster. :orange-frog    "orange frog"    "orange frogs"   nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:hostile})
  (Monster. :yellow-frog    "yellow frog"    "yellow frogs"   nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:hostile})
  (Monster. :green-frog     "green frog"     "green frogs"    nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:hostile})
  (Monster. :blue-frog      "blue frog"      "blue frogs"     nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:hostile})
  (Monster. :purple-frog    "purple frog"    "purple frogs"   nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:hostile})
