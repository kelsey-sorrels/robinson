...
(def ^:private monsters
  ...
  (Monster. :red-frog       "red frog"       "red frogs"      nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:docile})
  (Monster. :orange-frog    "orange frog"    "orange frogs"   nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:docile})
  (Monster. :yellow-frog    "yellow frog"    "yellow frogs"   nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:docile})
  (Monster. :green-frog     "green frog"     "green frogs"    nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:docile})
  (Monster. :blue-frog      "blue frog"      "blue frogs"     nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:docile})
  (Monster. :purple-frog    "purple frog"    "purple frogs"   nil  3 0 0.9   1     5    5 #{:head :body :leg :face}                   #{:claw}                      :hostile-after-attacked :random                                 4 #{:docile})
  ...
  (Monster. :fish           "fish"           "fish"           nil  9 0 1.2   4     7    8 #{:head :body :fin :tail}                   #{:bite}                      :retreat-after-attacked :random                                 1 #{:hostile})
  (Monster. :octopus        "octopus"        "octopodes"      nil 14 0 1.5  15     9    9 #{:head :body :tentacle}                    #{:bite :bite-venom :squeeze} :hostile-after-attack   :hide-from-player-in-range-or-random    2 #{:hostile})
  (Monster. :sea-snake      "sea snake"      "sea snakes"     nil  9 0 1.5   2     4    7 #{:head :body}                              #{:bite :bite-venom}          :hostile-at-night       :follow-player-in-range-or-random       2 #{:hostile})
  ...
  (Monster. :puffer-fish    "puffer fish"    "puffer fish"    nil  9 0 1.1   1     6    7 #{:head :body :tail}                        #{:sting-venom}               :hostile-during-day     :random                                 2 #{:hostile})
