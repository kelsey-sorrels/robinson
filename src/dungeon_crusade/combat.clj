...
(defn calc-dmg
  ...
  (condp vec-match? [attacker-race attack defender-race defender-body-part]
    ...
    [:bat        :bite         :human      :neck]      (+  (rand)  0.9)
    [:bird       :bite         :human      :*]         (+  (* (rand) 0.5)  0.5)
    [:bird       :claw         :human      :abdomen]   (+  (rand)  0.5)
    [:bird       :claw         :human      :face]      (+  (rand)  0.8)
    [:bird       :claw         :human      :neck]      (+  (rand)  0.7)
    [:bird       :claw         :human      :*]         (+  (rand)  0.5)
    [:boar       :bite         :human      :abdomen]   (+  (* 2.0 (rand))  0.5)
    [:boar       :bite         :human      :arm]       (+  (rand)  0.5)
    [:boar       :bite         :human      :face]      (+  (rand)  1.5)
    [:boar       :bite         :human      :foot]      (+  (rand)  0.5)
    [:boar       :bite         :human      :head]      (+  (rand)  1.5)
    [:boar       :bite         :human      :leg]       (+  (rand)  0.8)
    [:boar       :bite         :human      :neck]      (+  (rand)  1.5)
    [:boar       :gore         :human      :abdomen]   (+  (rand)  2.5)
    [:boar       :gore         :human      :arm]       (+  (rand)  1.5)
    [:boar       :gore         :human      :face]      (+  (rand)  3.5)
    [:boar       :gore         :human      :foot]      (+  (rand)  1.5)
    [:boar       :gore         :human      :head]      (+  (rand)  3.5)
    [:boar       :gore         :human      :leg]       (+  (rand)  2.5)
    [:boar       :gore         :human      :neck]      (+  (rand)  3.5)
    [:centipede  :bite         :human      :*]         (+  (* (rand) 0.5)  0.5)
    [:clam       :clamp        :human      :*]         (+  (* (rand) 0.2)  0.1)
    [:fish       :bite         :human      :*]         (+  (* (rand) 0.5)  0.2)
    [:frog       :claw         :human      :*]         (+  (* (rand) 0.3)  0.1)
    [:gecko      :bite         :human      :*]         (+  (* (rand) 0.2)  0.1)
    [:human      :punch        :bat        :body]      (+  (rand)  0.5)
    [:human      :punch        :bat        #{:face
                                             :head}]   (+  (rand)  0.8)
    [:human      :punch        :bat        :leg]       (+  (rand)  0.2)
    [:human      :punch        :bat        :wing]      (+  (rand)  0.8)
    [:human      :punch        :bird       :beak]      (+  (rand)  0.5)
    [:human      :punch        :bird       :body]      (+  (rand)  0.5)
    [:human      :punch        :bird       :head]      (+  (rand)  0.5)
    [:human      :punch        :bird       :leg]       (+  (* (rand) 0.5) 0.5)
    [:human      :punch        :bird       :tail]      (+  (rand)  0.5)
    [:human      :punch        :bird       :wing]      (+  (rand) 1.5)
    [:human      :punch        :boar       :body]      (+  (rand)  0.5)
    [:human      :punch        :boar       :eye]       (+  (rand)  2.5)
    [:human      :punch        :boar       :face]      (+  (rand)  0.9)
    [:human      :punch        :boar       :head]      (+  (rand)  0.3)
    [:human      :punch        :boar       :leg]       (+  (rand)  0.7)
    [:human      :punch        :boar       :snout]     (+  (rand)  0.7)
    [:human      :punch        :boar       :tail]      (+  (* (rand) 0.6)  0.1)
    [:human      :punch        :centipede  #{:body
                                             :head}]   (+  (rand)  0.9)
    [:human      :punch        :centipede  :leg]       (+  (* (rand) 0.2)  0.1)
    [:human      :punch        :clam       :shell]     (+  (rand)  0.5)
    [:human      :punch        :fish       #{:body
                                             :head}]   (+  (rand)  0.5)
    [:human      :punch        :fish       #{:fin
                                             :tail}]   (+  (* (rand) 0.6) 0.5)
    [:human      :punch        :frog       :*]         (+  (rand)  0.5)
    [:human      :punch        :gecko      :*]         (+  (rand)  0.5)
    ...
    [:human      :punch        :monkey     #{:body
                                             ...
                                             :head
                                             :neck}]   (+  (rand)  0.5)
    [:human      :punch        :monkey     :tail]      (+  (* (rand) 0.5)  0.5)
    ...
    [:human      :punch        :parrot     #{:leg
                                             :tail}]   (+  (* (rand) 0.7)  0.5)
    [:human      :punch        :parrot     :wing]      (+  (rand)  0.8)
