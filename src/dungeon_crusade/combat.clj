...
(defn calc-dmg
  ...
  (condp vec-match? [attacker-race attack defender-race defender-body-part]
    [:bat        :bite         :human      :abdomen]   (uniform-random 0.5 1.5)
    [:bat        :bite         :human      :arm]       (uniform-random 0.5 1.5)
    [:bat        :bite         :human      :face]      (uniform-random 0.5 1.5)
    [:bat        :bite         :human      :foot]      (uniform-random 0.5 1.5)
    [:bat        :bite         :human      :head]      (uniform-random 0.5 1.5)
    [:bat        :bite         :human      :leg]       (uniform-random 0.5 1.5)
    [:bat        :bite         :human      :neck]      (uniform-random 0.9 1.9)
    [:bird       :bite         :human      :*]         (uniform-random 0.5 0.9)
    [:bird       :claw         :human      :abdomen]   (uniform-random 0.5 1.5)
    [:bird       :claw         :human      :face]      (uniform-random 0.8 1.8)
    [:bird       :claw         :human      :neck]      (uniform-random 0.7 1.7)
    [:bird       :claw         :human      :*]         (uniform-random 0.5 1.5)
    [:boar       :bite         :human      :abdomen]   (uniform-random 0.5 2.5)
    [:boar       :bite         :human      :arm]       (uniform-random 0.5 3.5)
    [:boar       :bite         :human      :face]      (uniform-random 0.5 2.5)
    [:boar       :bite         :human      :foot]      (uniform-random 0.5 1.5)
    [:boar       :bite         :human      :head]      (uniform-random 1.5 3.5)
    [:boar       :bite         :human      :leg]       (uniform-random 0.9 1.8)
    [:boar       :bite         :human      :neck]      (uniform-random 1.5 2.5)
    [:boar       :gore         :human      :abdomen]   (uniform-random 2.5 4.5)
    [:boar       :gore         :human      :arm]       (uniform-random 1.5 2.5)
    [:boar       :gore         :human      :face]      (uniform-random 3.5 4.5)
    [:boar       :gore         :human      :foot]      (uniform-random 1.5 2.5)
    [:boar       :gore         :human      :head]      (uniform-random 3.5 4.5)
    [:boar       :gore         :human      :leg]       (uniform-random 2.5 3.5)
    [:boar       :gore         :human      :neck]      (uniform-random 3.5 4.5)
    [:centipede  :bite         :human      :*]         (uniform-random 0.5 0.9)
    [:clam       :clamp        :human      :*]         (uniform-random 0.1 0.3)
    [:fish       :bite         :human      :*]         (uniform-random 0.2 1.7)
    [:frog       :claw         :human      :*]         (uniform-random 0.1 0.5)
    [:gecko      :bite         :human      :*]         (uniform-random 0.1 0.3)
    [:human      :punch        :bat        :body]      (uniform-random 0.5 1.5)
    [:human      :punch        :bat        #{:face
                                             :head}]   (uniform-random 0.8 1.8)
    [:human      :punch        :bat        :leg]       (uniform-random 0.2 0.5)
    [:human      :punch        :bat        :wing]      (uniform-random 0.8 1.8)
    [:human      :punch        :bird       :beak]      (uniform-random 0.5 1.5)
    [:human      :punch        :bird       :body]      (uniform-random 0.5 1.5)
    [:human      :punch        :bird       :head]      (uniform-random 0.5 1.5)
    [:human      :punch        :bird       :leg]       (uniform-random 0.5 1.0)
    [:human      :punch        :bird       :tail]      (uniform-random 0.5 1.5)
    [:human      :punch        :bird       :wing]      (uniform-random 1.5 2.5)
    [:human      :punch        :boar       :body]      (uniform-random 0.5 1.5)
    [:human      :punch        :boar       :eye]       (uniform-random 2.5 3.5)
    [:human      :punch        :boar       :face]      (uniform-random 0.9 1.9)
    [:human      :punch        :boar       :head]      (uniform-random 0.3 1.3)
    [:human      :punch        :boar       :leg]       (uniform-random 0.7 1.7)
    [:human      :punch        :boar       :snout]     (uniform-random 0.7 1.7)
    [:human      :punch        :boar       :tail]      (uniform-random 0.1 1.1)
    [:human      :punch        :centipede  #{:body
                                             :head}]   (uniform-random 0.9 1.9)
    [:human      :punch        :centipede  :leg]       (uniform-random 0.1 0.5)
    [:human      :punch        :clam       :shell]     (uniform-random 0.5 1.5)
    [:human      :punch        :fish       #{:body
                                             :head}]   (uniform-random 0.5 1.5)
    [:human      :punch        :fish       #{:fin
                                             :tail}]   (uniform-random 0.5 1.1)
    [:human      :punch        :frog       :*]         (uniform-random 0.5 1.5)
    [:human      :punch        :gecko      :*]         (uniform-random 0.5 1.5)
    [:human      :punch        :monkey     #{:arm
                                             :leg}]    (uniform-random 0.5 1.5)
    [:human      :punch        :monkey     #{:body
                                             :face
                                             :head
                                             :neck}]   (uniform-random 0.5 1.5)
    [:human      :punch        :monkey     :tail]      (uniform-random 0.2 1.0)
    [:human      :punch        :octopus    #{:body
                                             :head}]   (uniform-random 1.5 2.9)
    [:human      :punch        :octopus    :tentacle]  (uniform-random 0.5 1.5)
    [:human      :punch        :parrot     #{:body
                                             :face
                                             :head}]   (uniform-random 0.5 1.5)
    [:human      :punch        :parrot     #{:leg
                                             :tail}]   (uniform-random 0.5 1.3)
    [:human      :punch        :parrot     :wing]      (uniform-random 0.8 1.8)
    [:human      :punch        :rat        #{:body
                                             :face
                                             :head
                                             :neck}]   (uniform-random 0.5 1.5)
    [:human      :punch        :rat        #{:leg
                                             :tail}]   (uniform-random 0.5 1.2)
    [:human      :punch        :scorpion   #{:abdomen
                                             :head
                                             :tail}]   (uniform-random 0.9 1.9)
    ...
    [:human      :punch        :shark      #{:body
                                             :head
                                             :nose}]   (uniform-random 0.5 1.5)
    [:human      :punch        :shark      #{:fin
                                             :tail}]   (uniform-random 0.5 1.1)
    [:human      :punch        :snake      #{:body
                                             :head
                                             :tail}]   (uniform-random 0.5 1.5)
    [:human      :punch        :spider     #{:abdomen
                                             :face}]   (uniform-random 0.5 1.5)
