    ...
    (condp vec-match? [attacker-race defender-race attack defender-body-part damage-type]
      ...
      [:human :*       :axe :*       :hit]  (dg/rand-nth [(format "You %s the %s %s %s the %s."
                                                           ...
                                                           (format "You %s the %s."
                                                             (rand-axe-verb)
                                                             defender-name)])
      [:human :*       :axe         :head     :dead] (format "You %s the %s in the head. Brains fly everywhere and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :neck     :dead] (format "You %s the %s in the neck snapping it and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :body     :dead] (format "You %s the %s in the body damaging internal organs. It dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :leg      :dead] (format "You %s the %s in the leg severing it and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :face     :dead] (format "You %s the %s in the face. Peices of face fly everywhere and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :abdomen  :dead] (format "You %s the %s in the abdomen. Internal organs fly everywhere and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :claw     :dead] (format "You %s the %s in the claw and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :tail     :dead] (format "You %s the %s in the tail causing massive injuries and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :wing     :dead] (format "You %s the %s in the wing ripping it clean off and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :eye      :dead] (format "You %s the %s in the eye exploding it upon impact and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :snout    :dead] (format "You %s the %s in the snount crushing it and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :arm      :dead] (format "You %s the %s in the arm crushing bones it and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :beak     :dead] (format "You %s the %s in the beak ripping it from its face and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :shell    :dead] (format "You %s the %s in the shell ripping to peices and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :tentacle :dead] (format "You %s the %s in the tentacle shredding it and it dies." (rand-axe-verb) defender-name)
      [:human :*       :axe         :*        :dead] (format "You %s the %s causing massive injuries and it dies." (rand-axe-verb) defender-name)
