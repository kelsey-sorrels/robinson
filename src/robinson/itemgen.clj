...
(defn arrow-poison-tipped?
  ...
  (and (contains? #{:red-tipped-arrow :orange-tipped-arrow :yellow-tipped-arrrow
                  ...
                  (get item :id))
       (contains? (get-in state [:world :frogs :poisonous])
                  (-> (clojure.string/split (name (get item :id)) #"-")
                      first
                      keyword))))
...
(def ^:private items
  [
   {:id  :stick                   :name  "stick"                      :name-plural "sticks"
    :fuel 100 :utility 100 :item/materials #{:wood}}
   {:id  :log                     :name  "log"                        :name-plural "logs"
    :fuel 500 :item/materials #{:wood}}
   {:id  :sharpened-stick         :name  "sharpened stick"            :name-plural "sharpened sticks"
    :attack :spear :fuel 100 :utility 100 :item/materials #{:wood}}
   {:id  :arrow                   :name  "arrow"                      :name-plural "arrows"
    :attack :spear :fuel 10 :item/materials #{:wood}}
   {:id  :red-tipped-arrow        :name  "red-tipped arrow"           :name-plural "red-tipped arrows"
    :attack :spear :fuel 10}
   {:id  :orange-topped-arrow     :name  "orange-tipped arrow"        :name-plural "orange-tipped arrows"
    :attack :spear :fuel 10}
   {:id  :yellow-tipped-arrow     :name  "yellow-tipped arrow"        :name-plural "yellow-tipped arrows"
    :attack :spear :fuel 10}
   {:id  :green-tipped-arrow      :name  "green-tipped arrow"         :name-plural "green-tipped arrows"
    :attack :spear :fuel 10}
   {:id  :blue-tipped-arrow       :name  "blue-tipped arrow"          :name-plural "blue-tipped arrows"
    :attack :spear :fuel 10}
   {:id  :purple-tipped-arrow     :name  "prurple-tipped arrow"       :name-plural "arrows"
    :attack :spear :fuel 10}
   {:id  :bow                     :name  "bow"                        :name-plural "bow"
    :fuel 10 :utility 100 :recoverable-item [:rope :stick]}
   {:id  :plant-fiber             :name  "plant fiber"                :name-plural "plant fibers"
    :fuel 50}
   {:id  :leaves                  :name  "leaves"                     :name-plural "leaves"
    :fuel 10}
   {:id  :unhusked-coconut        :name  "unhusked coconut"           :name-plural "husked coconuts"}
   {:id  :coconut                 :name  "coconut (full)"             :name-plural "coconuts (full)"
    :thirst 30}
   {:id  :coconut-empty           :name  "coconut (empty)"            :name-plural "coconuts (empty)"
    :hunger 30}
   {:id  :coconut-shell           :name  "coconut shell"              :name-plural "coconut shells"
    :fuel 30}
   {:id  :red-fruit               :name  "red fruit"                  :name-plural "red fruits"
    :hunger 30}
   {:id  :orange-fruit            :name  "orange fruit"               :name-plural "orange fruits"
    :hunger 30}
   {:id  :yellow-fruit            :name  "yellow fruit"               :name-plural "yellow fruits"
    :hunger 30}
   {:id  :green-fruit             :name  "green fruit"                :name-plural "green fruits"
    :hunger 30}
   {:id  :blue-fruit              :name  "blue fruit"                 :name-plural "blue fruits"
    :hunger 30}
   {:id  :purple-fruit            :name  "purple fruit"               :name-plural "purple fruits"
    :hunger 30}
   {:id  :white-fruit             :name  "white fruit"                :name-plural "white fruits"
    :hunger 30}
   {:id  :black-fruit             :name  "black fruit"                :name-plural "black fruits"
    :hunger 30}
   {:id  :jack-o-lantern          :name  "jack-o-lantern"             :name-plural "jack-o-lanterns"
    :hunger 10}
   ...
   {:id  :rope                    :name  "rope"                       :name-plural "ropes"
    :fuel 10}
   {:id  :bamboo                  :name  "bamboo"                     :name-plural "bamboo"}
   {:id  :obsidian-spear          :name  "obsidian spear"             :name-plural "obsidian spears"
    :attack :spear :fuel 50 :utility 50 :recoverable-items [:stick :obsidian-blade]}
   {:id  :obsidian-axe            :name  "obsidian axe"               :name-plural "obsidian axes"
    :attack :axe :fuel 50 :utility 50 :recoverable-items [:stick :obsidian-blade]}
   {:id  :obsidian-knife          :name  "obsidian knife"             :name-plural "obsidian knives"
    :attack :knife :fuel 10 :utility 50 :recoverable-items [:stick :obsidian-blade]}
   {:id  :flint-spear             :name  "flint spear"                :name-plural "flint spears"
    :attack :spear :fuel 50 :utility 100 :recoverable-items [:stick :flint-blade]}
   {:id  :flint-axe               :name  "flint axe"                  :name-plural "flint axes"
    :attack :axe :fuel 50 :utility 100 :recoverable-items [:stick :flint-blade]}
   {:id  :flint-knife             :name  "flint knife"                :name-plural "flint knives"
   ...
   {:id  :hand-drill              :name  "hand drill"                 :name-plural "hand drills"
    :utility 3}
   {:id  :fire-plough             :name  "fire plough"                :name-plural "fire ploughs"
    :utility 3}
   {:id  :bow-drill               :name  "bow drill"                  :name-plural "bow drills"
    :utility 5}
   {:id  :hand-drill              :name  "hand drill"                 :name-plural "hand-drills"
    :utility 5}
   ...
   {:id  :match                   :name  "match"                      :name-plural "matches"
    :fuel 10}
   {:id  :knife                   :name  "knife"                      :name-plural "knives"
   ...
   {:id  :ration                  :name  "ration"                     :name-plural "rations"
    :type :food :hunger 100}
   {:id  :lantern                 :name  "lantern"                    :name-plural "lanterns"
    :charge 1500}
   ...
   {:id  :pen                     :name  "pen"                        :name-plural "pens"
    :utility 1}
   {:id  :radio                   :name  "radio"                      :name-plural "radios"
    :utility 1}
   {:id  :flare-gun               :name  "flare gun"                  :name-plural "flare guns"
    :utility 1}
   {:id  :signal-mirror           :name  "signal mirror"              :name-plural "signal mirrors"
    :utility 100}
   {:id  :flag                    :name  "flag"                       :name-plural "flags"}
   {:id  :locator-beacon          :name  "locator beacon"             :name-plural "locator beacons"
    :utility 100}
   ;; pirate ship items
   ...
   {:id  :cutlass                 :name "cutlass"                     :name-plural "cutlasses"
    :attack :cutlass :utility 50}
   {:id  :pistol                  :name "flintlock pistol"            :name-plural "flintlock pistols"}
   {:id  :paper-cartridge         :name "paper cartridge"             :name-plural "paper cartridges"
    :fuel 10}
   {:id  :ale                     :name "bottle of ale"               :name-plural "bottles of ale"
    :thirst 50}
   {:id  :pirate-clothes          :name "pirate clothes"              :name-plural "pirate clothes"
    :utility 100 :toughness 0.2}
   {:id  :navy-uniform            :name "navy uniform"                :name-plural "navy uniforms"
    :utility 100 :toughness 0.2}
   ;; ruined temple items
   ...
   {:id  :robe                    :name "robe"                        :name-plural "robes"
    :fuel 20}
   {:id  :ritual-knife            :name "ritualistic knife"           :name-plural "ritualistic knives"
    :attack :ritualistic-knife :utility 20}
   {:id  :ancient-spear           :name "ancient spear"               :name-plural "ancient spears"
    :attack :ancient-spear :utility 20}
   {:id  :blowgun                 :name "blowgun"                     :name-plural "blowguns"}
   {:id  :blowdart                :name "blowdart"                    :name-plural "blowdarts"
    :fuel 10}
