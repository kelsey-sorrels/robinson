...
(def ^:private monsters
  ...
  ;;                                                                           strength
  ;;                                                                               toughness
  ;;                                                                                  body-parts                                  attacks                       temperment                            movement policy                       range-threshold
  ;;                                                                                                                                                                                                                                          status
  ...
  (Monster. :fish           "fish"           "fish"            4 0 1.2   4     1    8 #{:head :body :fin :tail}                   #{:bite}                      :hide-from-player-in-range-or-random  :hide-from-player-in-range-or-random  1 #{:hostile})
  (Monster. :octopus        "octopus"        "octopodes"       4 0 1.5  15     5    4 #{:head :body :tentacle}                    #{:bite :bite-venom :squeeze} :hide-from-player-in-range-or-random  :hide-from-player-in-range-or-random  2 #{:hostile})
  ...
  (Monster. :squid          "squid"          "squids"          4 0 1.5  10     6    4 #{:head :body :tentacle}                    #{:bite :squeeze}             :hide-from-player-in-range-or-random  :hide-from-player-in-range-or-random  2 #{:hostile})
  ...
  (Monster. :tarantula      "tarantula"      "tarantulas"      2 0 1.4   0.1   0.2  2 #{:head :body :leg}                         #{:bite}                      :retreat-after-attacked               :hide-from-player-in-range-or-random  2 #{:hostile})
